...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/prime/icon/product.png")), "Sản phẩm"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/prime/icon/voucher.png")), "Quản lý Voucher"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/prime/icon/order.png")), "Bán hàng "));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/prime/icon/invoice.png")), "Hóa đơn"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/prime/icon/user.png")), "Quản lý tài khoản", "Nhân viên", "Khách hàng"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/prime/icon/statistic.png")), "Thống kê"));
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.decode("#2F80ED"), getWidth(), 0, Color.decode("#56CCF2"));
        g2.setPaint(gra);
